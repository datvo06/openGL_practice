...
CTM::Vector3 CTM::Cross(CTM::Vector3 &v1, CTM::Vector3 &v2)
{
  return Vector3(
    v1.y * v2.z - v1.z * v2.y,
    v1.z * v2.x - v1.x * v2.z,
...
/// Normalize a vector
CTM::Vector3 CTM::Normalize(CTM::Vector3 v)
{
...
CTM::Mesh::NormalCalcAlgo CTM::Mesh::DetectNormalCalculationMethod()
{
...
void CTM::Mesh::CalculateNormals(NormalCalcAlgo aAlgo)
{
...
void CTM::Mesh::BoundingBox(Vector3 &aMin, Vector3 &aMax)
{
  if(mVertices.size() < 1)
