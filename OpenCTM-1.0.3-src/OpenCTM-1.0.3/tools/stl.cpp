...
void CTM::Import_STL(const char * aFileName, CTM::Mesh * aMesh)
{
  // Clear the mesh
  aMesh->Clear();
...
void CTM::Export_STL(const char * aFileName, Mesh * aMesh, Options &aOptions)
{
