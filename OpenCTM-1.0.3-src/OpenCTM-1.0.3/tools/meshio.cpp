...
void CTM::ImportMesh(const char * aFileName, Mesh * aMesh)
{
...
void CTM::ExportMesh(const char * aFileName, Mesh * aMesh, Options &aOptions)
{
  string fileExt = UpperCase(ExtractFileExt(string(aFileName)));
  if(fileExt == string(".CTM"))
...
void CTM::SupportedFormats(list<string> &aList)
{
