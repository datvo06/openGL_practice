...
class Obj3DS {
  public:
    ...
    vector<CTM::Vector3> mVertices;
    vector<CTM::Vector2> mUVCoords;
};
...
static CTM::Vector2 ReadVector2(istream &aStream)
{
  union {
    uint32 i;
    float  f;
...
static void WriteVector2(ostream &aStream, CTM::Vector2 aValue)
{
  union {
    uint32 i;
    float  f;
...
static CTM::Vector3 ReadVector3(istream &aStream)
{
  union {
    uint32 i;
    float  f;
...
static void WriteVector3(ostream &aStream, CTM::Vector3 aValue)
{
  union {
    uint32 i;
    float  f;
...
void CTM::Import_3DS(const char * aFileName, Mesh * aMesh)
{
  // Clear the mesh
  aMesh->Clear();
...
void CTM::Export_3DS(const char * aFileName, Mesh * aMesh, Options &aOptions)
{
