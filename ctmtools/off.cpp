...
static void ParseVeretex(const string aString, CTM::Vector3 * aCoord, CTM::Vector4 * aColor)
{
...
void CTM::Import_OFF(const char * aFileName, CTM::Mesh * aMesh)
{
  // Clear the mesh
  aMesh->Clear();
  ...
  CTM::Vector4 firstColor = aMesh->mColors[0];
...
void CTM::Export_OFF(const char * aFileName, Mesh * aMesh, Options &aOptions)
{
