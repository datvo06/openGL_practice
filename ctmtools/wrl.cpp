...
void CTM::Import_WRL(const char * aFileName, CTM::Mesh * aMesh)
{
...
void CTM::Export_WRL(const char * aFileName, Mesh * aMesh, Options &aOptions)
{
