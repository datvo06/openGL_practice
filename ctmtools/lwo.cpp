...
static CTM::Vector3 ReadVEC12(istream &aStream)
{
...
/// Note: We flip the Y & Z axes, to go from our right handed to LightWaves
/// left handed coordinate system.
static void WriteVEC12(ostream &aStream, CTM::Vector3 aValue)
{
  unsigned char buf[12];
  union {
    uint32 i;
...
/// account...
static uint32 CalcPOLSSize(CTM::Mesh * aMesh)
{
...
static uint32 CalcVMAPSize(CTM::Mesh * aMesh, uint32 aDimension)
{
...
void CTM::Import_LWO(const char * aFileName, Mesh * aMesh)
{
  // Open the input file
...
void CTM::Export_LWO(const char * aFileName, Mesh * aMesh, Options &aOptions)
{
