...
static CTM::Vector2 ParseVector2(const string aString)
{
  CTM::Vector2 result;
...
static CTM::Vector3 ParseVector3(const string aString)
{
  CTM::Vector3 result;
  istringstream sstr(aString);
  sstr >> result.x;
...
void CTM::Export_OBJ(const char * aFileName, CTM::Mesh * aMesh, CTM::Options &aOptions)
{
