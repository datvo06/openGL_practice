...
void init(){
	...
	const char* shaderSource = DatTools::Util::string_from_file_c("vertex.glsl");
	...
	const char* fragmentShaderSource = DatTools::Util::string_from_file_c("fragment.glsl");
	...
	/*
	 * Linked to the program, no longer needed
	 */
